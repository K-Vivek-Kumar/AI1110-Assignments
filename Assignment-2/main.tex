...
\end{align}
\begin{align}
\implies \frac{df(x)}{dx} = \frac{1}{2\sqrt{2x-3}}(2)
\end{align}
\begin{align}
...
$\therefore f(x)$ is an onto, i.e., a subjective function.
	...
	\end{figure}\\
	We can clearly see that, the graph is symmetric about the line, $y = x$. Hence, we obtained that for $f(x)=\sqrt{2x-3}$, we get
	\begin{align} \label{eq:1.1}
	f^{-1}(x) = \frac{x^{2} + 3}{2}
	\end{align}
	\item
	\textbf{\underline{Proving that:}} $(fof^{-1})(x)=x$\\
	Solving R.H.S.,\\
